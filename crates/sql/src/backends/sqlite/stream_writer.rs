...
use storage_types::{
    ...
    StoredTableInfo, StreamName, TimestampMillis,
};
...
#[derive(Clone, Copy)]
pub(crate) struct SqliteWriteStreamEntriesInput<'a> {
...
pub fn write_stream_entries(
    ...
    input: SqliteWriteStreamEntriesInput<'_>,
) -> Result<(), StorageError> {
    ...
    let SqliteWriteStreamEntriesInput {
        old_item,
        indexers,
        old_indexers,
        is_deleted,
